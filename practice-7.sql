...
SELECT listings.property_type, COUNT(reviews.id), MAX(reviews.date_reviewed) FROM listings INNER JOIN reviews ON listings.id=reviews.listing_id GROUP BY listings.property_type;
-- +-------------------------------------+----------+----------------------------+
-- | Boat                                | 2        | 2021-06-19                 |
